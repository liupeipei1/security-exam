...
VALUES ('security_level3', '网络与信息安全管理员三级', '网络与信息安全管理员（三级）理论知识考试', '本考试包含网络与信息安全管理员职业技能等级认定三级考试的理论知识复习题，涵盖网络安全基础、信息安全管理、安全技术应用等核心知识点，帮助考生系统复习备考。', '本考试包含网络与信息安全管理员职业技能等级认定三级考试的理论知识复习题，涵盖网络安全基础、信息安全管理、安全技术应用等核心知识点，帮助考生系统复习备考。', '🔒', 'security_exam_3', 0, 0, 0, 0, 1, 1);

-- 为人工智能训练师三级考试创建配置记录
INSERT INTO exam_config (exam_code, exam_name, exam_description, exam_desc_detail, description, icon, table_name, total_questions, judgment_count, single_count, multiple_count, enabled, sort_order) 
VALUES ('ai_trainer_3', '人工智能训练师三级', '人工智能训练师（三级）理论知识考试', '本考试包含人工智能训练师职业技能等级认定三级考试的理论知识复习题，涵盖人工智能基础、数据标注、模型训练、职业道德等核心知识点，共计900道题目（判断题300道、单选题300道、多选题300道）。', '本考试包含人工智能训练师职业技能等级认定三级考试的理论知识复习题，涵盖人工智能基础、数据标注、模型训练、职业道德等核心知识点，共计900道题目（判断题300道、单选题300道、多选题300道）。', '🤖', 'bank_ai_trainer_3', 900, 300, 300, 300, 1, 2);
