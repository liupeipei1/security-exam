...
import com.exam.exam.repository.ExamConfigRepository;
...
public class ExamConfigService {
    ...
    private final ExamConfigRepository configRepository;

    public ExamConfigService(ExamConfigRepository configRepository) {
    ...
    public Map<String, Object> createExam(Map<String, Object> data) {
        ...
        config.setEnabled(getIntValue(data, "enabled", 1));
    ...
    private Map<String, Object> toConfigMap(ExamConfigEntity config) {
        ...
        map.put("created_at", config.getCreatedAt() != null ? config.getCreatedAt().format(FMT) : null);
        map.put("updated_at", config.getUpdatedAt() != null ? config.getUpdatedAt().format(FMT) : null);
        return map;
    }
