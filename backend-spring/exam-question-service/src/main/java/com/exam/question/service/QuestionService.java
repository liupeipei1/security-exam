...
public class QuestionService {
     ...
     * @return 是否更新成功
     */
    public boolean updateQuestion(String bankCode, Long questionId, String question, String options,
     ...
     * @return 是否删除成功
     */
    public boolean deleteQuestion(String bankCode, Long questionId) {
        String table = validateTable(bankService.resolveTableName(bankCode));
     ...
     * @return 导入结果
     */
    public Map<String, Object> importQuestions(String content, String bankCode, String questionType, 
